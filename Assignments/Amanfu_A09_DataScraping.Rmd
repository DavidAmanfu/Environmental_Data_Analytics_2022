...
scrapetest <- data.frame("Year"=rep("2017",12),
                         ...
                         "Withdrawals"=max.withdrawals.mgd) %>% mutate("yearchar" =ym(paste0(Year,"-",Month)))
#5
scrapetest
durham2020 <- ggplot(scrapetest,aes(x=yearchar))+geom_point(aes(y=Withdrawals))
durham2020
...
DurhAshe
DurhAsheville2015 <- ggplot(DurhAshe,aes(x=yearchar,y=Withdrawals))+geom_point(aes(color=System))+labs(title="2015 Max Withdrawals, Durham",x="Date")
DurhAsheville2015
...
```{r}
#9
yeargap <- seq(2010,2019,1)
yeargap
Asheville20102019 <- for (i in yeargap) {
                            scrape.it(yeargap[i],'01-11-010')
}
Asheville20102019

scrape.it(2011,'01-11-010')
scrape.it(2012,'01-11-010')
scrape.it(2013,'01-11-010')
scrape.it(2014,'01-11-010')
scrape.it(2015,'01-11-010'),scrape.it(2016,'01-11-010'),scrape.it(2017,'01-11-010'),scrape.it(2018,'01-11-010'),scrape.it(2019,'01-11-010'))
Asheville20102019
```
