...
Durham_LWSP <- read_html('https://www.ncwater.org/WUDC/app/LWSP/report.php?pwsid=03-32-010&year=2020')
Durham_LWSP
```
...
```{r scrape.the.data}
#3
water.system.name <- Durham_LWSP %>% html_nodes('ttable:nth-child(7) tr:nth-child(1) td:nth-child(2)') %>% html_text()
...
max.withdrawals.mgd <- Durham_LWSP %>% html_nodes(':nth-child(31) td:nth-child(9) , tr:nth-child(4) :nth-child(9) tr:nth-child(3) tr:nth-child(2) :nth-child(9), :nth-child(31) td:nth-child(6), :nth-child(31) td:nth-child(3)') %>% html_text()
```
