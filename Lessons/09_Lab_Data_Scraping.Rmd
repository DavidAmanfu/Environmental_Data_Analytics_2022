...
scrape.it <- function(the_year, the_facility){
  ...
  max.withdrawals.mgd_node <- ':nth-child(31) td:nth-child(9) , tr:nth-child(4) :nth-child(9) tr:nth-child(3) tr:nth-child(2) :nth-child(9), :nth-child(31) td:nth-child(6), :nth-child(31) td:nth-child(3)'
  ...
  df_withdrawals <- data.frame("Year"=rep(the_year,12),
    ...
    scrapetest <- scrapetest %>% mutate("yearchar" =ym(paste0(Year,"-",Month)))
...
#7
scrapetest3 <-scrape.it(2017,'03-32-010')
scrapetest2
durham2020 <- ggplot(scrapetest2,aes(x=yearchar))+geom_point(aes(y=Withdrawals))
durham2020
