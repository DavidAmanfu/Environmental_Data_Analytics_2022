...
ggplot(EPAair)+
  ...
  labs(fill="Year",title = "Ozone AQI Value", x = "03 AQI", y= "Density")

ggplot(EPAair)+
  geom_boxplot(aes(x=as.factor(Year),y=Ozone,color=as.factor(Year)))+
  labs(color="Year",title = "Ozone AQI Value", x = "Year", y= "Density")
...
ggplot(EPAair,aes(x=Ozone,y=PM2.5))+ #,fill=as.factor(Year)
  geom_point()+
  geom_smooth(method='lm')

our_lm <- lm(EPAair$PM2.5 ~ EPAair$Ozone)
summary(our_lm)
